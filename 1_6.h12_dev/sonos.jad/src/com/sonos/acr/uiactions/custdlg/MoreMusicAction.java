...
public class MoreMusicAction extends DisplayCustomControlAction
{

    public MoreMusicAction(SonosActivity sonosactivity)
    {
        super(sonosactivity);
    ...
    public SCActionCompletionStatus perform(SCIActionContext sciactioncontext)
    {
        ...
        {
            m_sonosActivity.showMoreMusic(sciactioncontext.getPropertyBag());
            scactioncompletionstatus = SCActionCompletionStatus.DONE_WITH_ACTION;
        }

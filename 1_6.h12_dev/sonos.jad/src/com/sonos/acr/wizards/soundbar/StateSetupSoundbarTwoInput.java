...
public class StateSetupSoundbarTwoInput extends SoundbarWizardState
{

    public StateSetupSoundbarTwoInput(SoundbarWizard soundbarwizard, com.sonos.sclib.SCISoundbarWizard.SoundbarWizardState soundbarwizardstate)
    {
...
_L1:
        getWizard().setInputSelected(true);
        transitionNext();
_L4:
        return;
_L2:
        ...
        {
            getWizard().setInputSelected(false);
            transitionNext();
        }

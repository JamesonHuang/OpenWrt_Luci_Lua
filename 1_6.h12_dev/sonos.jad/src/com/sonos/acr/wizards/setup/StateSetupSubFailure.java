...
public class StateSetupSubFailure extends SetupWizardState
{

    public StateSetupSubFailure(SetupWizard setupwizard, com.sonos.sclib.SCISetupWizard.SetupWizardState setupwizardstate)
    {
...
_L2:
        ...
        {
            getWizard().setSubTryAgain(false);
            transitionNext();
        }

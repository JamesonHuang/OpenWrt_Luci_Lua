...
public final class MonitorableHttpURLConnection extends HttpURLConnection
{
    ...
    public InputStream getErrorStream()
    {
        ...
        if(original instanceof HttpURLConnection)
            inputstream = ((HttpURLConnection)original).getErrorStream();
        else
            inputstream = null;
        return inputstream;
    }
    ...
    public boolean getInstanceFollowRedirects()
    {
        boolean flag;
        if(original instanceof HttpURLConnection)
            flag = ((HttpURLConnection)original).getInstanceFollowRedirects();
        else
            flag = true;
        return flag;
    }
    ...
    public String getRequestMethod()
    {
        String s;
        if(original instanceof HttpURLConnection)
            s = ((HttpURLConnection)original).getRequestMethod();
        else
            s = "GET";
        return s;
    }
        ...
        throws IOException
    {
        int i;
        if(original instanceof HttpURLConnection)
            i = ((HttpURLConnection)original).getResponseCode();
        else
            i = -1;
        return i;
    }
        ...
        throws IOException
    {
        String s;
        if(original instanceof HttpURLConnection)
            s = ((HttpURLConnection)original).getResponseMessage();
        else
            s = "";
        return s;
    }
    ...
    public boolean usingProxy()
    {
        boolean flag;
        if(original instanceof HttpURLConnection)
            flag = ((HttpURLConnection)original).usingProxy();
        else
            flag = false;
        return flag;
    }
